    ...
    for (region_ind in 1:parcels$region_num){
      ...
      if (develop_num > 0){
        ...
        for (dev_index in 1:develop_num){    #loop over the number of possible developments           
          ...
          outputs$trajectories = write_offset_trajectory(outputs$trajectories, counterfactuals, offset_object, current_ecology, params, time_remaining, yr)         
          index_object = update_index(index_object, offset_object$current_parcel_indexes, region_ind, params)
...
# plot_outs(true_offset_gains$region_sums, avoided_degredation$region_sums, offset_gains_rel_to_current$region_sums, plot_params)
# 
