...
source('~/Documents/R Codes/Offsets/Params.R')
...
# for (s in 1:1000){
#   outputs_trial <- calc_trajectories(params, outputs, parcels, index_object, counterfactuals, perform_offsets = FALSE)
#   for (t in 1:params$time_steps){
#     time_slice = outputs_trial$trajectories[, , t]
#     filename = paste('~/R Data/test_', s, '_time_slice_', t, '.rds', sep = '')    
#     saveRDS(time_slice, filename)
#   }
#   print(s)
# }

# saveRDS(params, '~/R Data/params.rds')
# saveRDS(parcels, '~/R Data/parcels.rds')
# saveRDS(counterfactuals, '~/R Data/counterfactuals.rds')
...
adjusted_counterfactual_sums <- find_sums(params$time_steps, parcels, outputs_offsets_off$adjusted_counterfactuals)
...
plot_outs(adjusted_counterfactual_sums$region_sums, counterfactual_sums$region_sums, plot_params)

#parcels_object_offsets_off <- collate_parcel_sets(outputs_offsets_off$parcel_sets, params)
parcels_object <- collate_parcel_sets(outputs$index_object$parcel_sets, globalparams$time_steps)
